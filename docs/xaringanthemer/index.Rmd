...
subtitle: "with xaringanthemer"
author: "Garrick Aden-Buie"
date: 'Tampa UseRs Group<br>February 25, 2020'
output:
...
knitr::opts_chunk$set(fig.showtext = TRUE, fig.width = 8, fig.height = 6, dpi = 300)
```

# xaringanthemer

### pkg.garrickadenbuie.com/xaringanthemer/dev
...
.silver[Install from .code[dev] branch!]

### Create our slide's theme
...
.pull-left[
```{r plot-regular, comment='#', fig.show='hide'}
ggplot(iris) +
...
.pull-right[
![](`r knitr::fig_chunk("plot-regular", "png")`)
]
...
.pull-left[
```{r plot-xt-inverse, fig.show='hide'}
ggplot(iris) +
    aes(Petal.Length, Petal.Width) +
    geom_point() +
    ggtitle("Yet another Iris plot") +
...
.pull-right[
![](`r knitr::fig_chunk("plot-xt-inverse", "png")`)
]
